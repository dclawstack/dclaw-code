...
### Can I run DClaw Code without Kubernetes?

Yes, for local development:

```bash
cd dclaw-code/frontend && npm run dev
cd dclaw-code/backend && uvicorn dclaw_code.main:app --reload
```
